...
sources:
  ...
  - id: opendap-dmr
    ...
    title: "DAP4 metadata of the OCO-2 Lite SIF granule of 2024-04-02 (read 2026-09-15: the description attributes of Daily_SIF_740nm, SIF_740 times /Science/daily_correction_factor, and of daily_correction_factor, a correction factor to estimate daily average SIF from instantaneous SIF using pure geometric incoming light scaling; the on-premises URL is retired after September 2026 and the durable form of the same metadata is the Cloud OPeNDAP .dmr.xml of the granule behind Earthdata Login)"
  - id: parazoo-2019
