...
type: dataset-gotcha
spheres: [geosphere]
title: "NASADEM heights are not all SRTM: the NUM layer says which pixels are ASTER GDEM, ALOS PRISM, an older SRTM edit or interpolation, and inside the HGT granule only it separates the February 2000 radar heights from the optical fill acquired years later"
