...
sources:
  ...
  - id: recipe-mass
    resource: ../recipes/grace-mass-to-sea-level.md
...
[^nasa-ssh]: datasets/nasa-ssh.md, the altimetry term's product, its dynamic atmospheric correction and its era dependence
[^mascons]: datasets/grace-fo-mascons.md, the mass term's product and its formal uncertainty grids
[^gotcha-gia]: gotchas/grace-gia-correction.md
[^gotcha-leakage]: gotchas/grace-coastal-leakage.md
[^gotcha-gap]: gotchas/grace-intermission-gap.md, the hole, the missing months and the bridging evidence
[^gotcha-low-degree]: gotchas/grace-low-degree-replacements.md
[^recipe-mass]: recipes/grace-mass-to-sea-level.md, the mascon sum, the trend on the epochs and the gigatonne to millimeter constant
[^recipe-budget]: recipes/sea-level-budget.md, the three terms and how the residual is read
