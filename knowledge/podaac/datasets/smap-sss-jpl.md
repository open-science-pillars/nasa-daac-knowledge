...
version: "JPL CAP V5.0 (documentation dated 2020-11-12, release 2020-12-11), CMR-verified 2026-09-13 (provider POCLOUD): SMAP_JPL_L3_SSS_CAP_8DAY-RUNNINGMEAN_V5 (C2208422957-POCLOUD, DOI 10.5067/SMP50-3TPCS, daily files whose first window is 2015-04-30 to 2015-05-08 and whose last on the date is centred on 2026-09-05) and SMAP_JPL_L3_SSS_CAP_MONTHLY_V5 (C2208423975-POCLOUD, DOI 10.5067/SMP50-3TMCS, 2015-04 through 2026-08); the alternative producer's collections are RSS V6.0 (validated release 2024-01-18), SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6 (C2832227567-POCLOUD, DOI 10.5067/SMP60-3SPCS, from 2015-03-28) and SMAP_RSS_L3_SSS_SMI_MONTHLY_V6 (C2832226365-POCLOUD, DOI 10.5067/SMP60-3SMCS, 2015-04 through 2026-05 on the date)"
status: draft
...
sources:
  ...
  - id: cmr-jpl-8day
    ...
    title: "CMR collection record for the JPL 8-day product, with its granule range on the verification date (read 2026-09-13)"
  - id: cmr-jpl-monthly
    resource: https://cmr.earthdata.nasa.gov/search/concepts/C2208423975-POCLOUD.umm_json
    title: "CMR collection record for the JPL monthly product, with its granule range on the verification date (read 2026-09-13)"
  - id: jpl-guide
  ...
  - id: cmr-rss
    ...
    title: "CMR collection record for the RSS monthly product; the RSS 8-day record is C2832227567-POCLOUD; both granule ranges read on 2026-09-13, with the older RSS V4, V5 and V5.3 collections still catalogued"
  - id: rss-release
  ...
  - id: tang-2017
    ...
    title: "Tang and others, 2017, Validating SMAP SSS with in situ measurements, Remote Sensing of Environment 200, 326 to 340: the validation paper the guide and the files cite (registry record verified; the article was not read)"
  - id: meissner-2018
    resource: https://doi.org/10.3390/rs10071121
    title: "Meissner, Wentz and Le Vine, 2018, The salinity retrieval algorithms for the NASA Aquarius version 5 and SMAP version 3 releases, Remote Sensing 10, 1121: the RSS algorithm line (abstract read on the registry record)"
---
...
1000 km swath, global coverage in about three days and an exact
eight-day repeat; its radar failed on 7 July 2015, so the salinity
retrieval is radiometer-only with an ancillary wind for the roughness
...
collections: an 8-day running mean written as one file per day, seven
days behind, and a monthly mean about a month behind, both on a
0.25-degree grid with an effective resolution of about 60 km; the
...
(8 or MONTHLY).[^jpl-guide][^cmr-jpl-monthly]
...
Its 8-day record starts on 2015-03-28 and its monthly record in April
2015; on 2026-09-13 the last archived monthly file was May 2026, three
months behind the JPL monthly, and the older RSS versions 4, 5 and the
5.3 evaluation set (which ends at the start of 2024) remain
catalogued.[^cmr-rss] The two lines are not interchangeable; the
...
[^cmr-jpl-8day]: CMR collection record, C2208422957-POCLOUD, and its granule range
[^cmr-jpl-monthly]: CMR collection record, C2208423975-POCLOUD, and its granule range
