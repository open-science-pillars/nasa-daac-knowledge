...
- 2026-08-30 · bundle scaffolded with eight requirement concepts (kit 11
  Session 2, run in adapted form before the Science Enabling Team
  invite: all drafts, no signatures, SET names reserved for signing
