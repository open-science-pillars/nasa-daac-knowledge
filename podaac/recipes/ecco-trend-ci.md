...
description: "How to turn a monthly series out of a sanctioned receipt into a trend with a 95 percent interval that respects serial correlation: deseasonalize over complete years, fit, estimate r1, shrink the sample to n_eff, and let the t distribution on the effective degrees of freedom set the width."
...
expected: "Reference series us-northeast-coast steric height, 2010-01 through 2010-12, scaled to mm, deseasonalize none (measured 2026-09-02): trend +135.7772 mm per year, r1 +0.555, n_eff 3.43 of 12, 95 percent interval [-701.5, +973.1] mm per year; naive half width 109.8, honest 837.3"
expected_uncertainty: "The interval is calibrated in the regime it is meant for: at 120 months or more and lag-1 autocorrelation up to 0.8 the measured coverage is 92.0 to 95.0 percent (asserted band 90 to 97.5). At 12 or 24 months coverage is 82 to 86 percent and the tool declines to state an interval in up to 7 percent of trials; treat any n_eff below about 10 as a description of the window, not a trend. The interval is a statement about sampling under an AR(1) residual model, not about model or observational error in the series"
...
Then: remove the monthly climatology, but only over complete years
(the tool refuses otherwise, because a climatology formed over a
partial year steals part of the trend); fit an ordinary least squares
slope against months; take the lag-1 autocorrelation r1 of the
residuals; shrink the sample to n_eff = n (1 - r1) / (1 + r1); and let
Student's t on n_eff - 2 degrees of freedom set the interval. Report
the trend, the interval, r1 and n_eff together. Never the trend
alone.[^naked-trend]
...
covers under half the time once r1 reaches 0.8.[^attested-computation]
