...
| manifest | `ocean-science/knowledge/references/retrieval/nasa-ssh-manifest.json` (SHA-256 per file, identity read from the netCDF attributes of every file, the fetch record carried in); SHA-256 of the manifest `578b8f29b8cd7aff69be3eea74fa330f32e0bad4635e38b6e37d0b97f3e3e449` |
| verification report | `ocean-science/knowledge/references/retrieval/nasa-ssh-verification.json`: declared 1315, present 1315, checksum ok 1315, undeclared 0, stamped 2026-09-03T05:37:50Z |
